      ...
      // public properties
        ...
        methods = {
          ...
          goTo: function(index) {
            ...
            // Resize Container
            TweenMax.to(p.container, def.resizeContainerDuration, {
              css: {
                height: _nh
              }
            });
            ...
            TweenMax.to($small, def.outDuration, {
              css: def.outAnimation.small,
              delay: def.inDuration / 2
            });
            TweenMax.to($h2, def.outDuration, {
              css: def.outAnimation.h2,
              delay: def.inDuration / 2
            });
            TweenMax.to($p, def.outDuration, {
              css: def.outAnimation.p,
              delay: def.inDuration / 2
            });
            TweenMax.to($img, def.outDuration, {
              css: def.outAnimation.img
            });
            // Next Slide
            setTimeout(function() {
              ...
              TweenMax.from($small, def.inDuration, {
                css: def.inAnimation.small,
                delay: def.inDuration / 2
              });
              TweenMax.from($h2, def.inDuration, {
                css: def.inAnimation.h2,
                delay: def.inDuration / 2
              });
              TweenMax.from($p, def.inDuration, {
                css: def.inAnimation.p,
                delay: def.inDuration / 2
              });
              TweenMax.from($img, def.inDuration, {
                css: def.inAnimation.img
              });
              // Animation End
              setTimeout(function() {
